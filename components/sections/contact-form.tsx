  ...
  return (
    <section id="contact" className="bg-neutral-50 px-10 py-[100px]">
      <div className="mx-auto max-w-[900px]">
        ...
        <div className="max-w-[680px] rounded-3xl border border-neutral-200 bg-white p-14 max-sm:p-8">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
                <div>
                  ...
                  <Input placeholder="학원명 또는 채널명·브랜드명" required value={form.bizName} onChange={set("bizName")} className="rounded-xl border-neutral-200 py-3.5 text-[15px] focus-visible:ring-[#C9A84C]" />
                </div>
                <div>
                  <label className="mb-2 block text-[13px] font-bold">유형 *</label>
                  <select required value={form.bizType} onChange={set("bizType")}
                    className="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3.5 text-[15px] outline-none focus:border-[#C9A84C]">
              ...
              <div>
                ...
                <Textarea required value={form.pain} onChange={set("pain")} placeholder="지금 가장 해결하고 싶은 것을 자유롭게 적어주세요" className="min-h-[96px] rounded-xl border-neutral-200 text-[15px] focus-visible:ring-[#C9A84C]" />
              </div>

              <div>
                <label className="mb-2 block text-[13px] font-bold">연락처 *</label>
                <Input type="tel" required value={form.phone} onChange={set("phone")} placeholder="010-0000-0000" className="rounded-xl border-neutral-200 py-3.5 text-[15px] focus-visible:ring-[#C9A84C]" />
              </div>

              <Button type="submit" disabled={loading}
                className="mt-2 h-auto rounded-xl bg-[#0a0a0a] py-4.5 text-[16px] font-bold tracking-[0.02em] hover:bg-neutral-800 disabled:opacity-50">
